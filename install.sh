...
#
# oasdiff
# https://github.com/Barterio/oasdiff
...
ISSUE_URL="https://github.com/Barterio/oasdiff/issues/new"
...
get_download_url() {
  ...
  echo "https://github.com/Barterio/oasdiff/releases/download/v$1/${asset_name}"
}

get_checksum_url() {
  echo "https://github.com/Barterio/oasdiff/releases/download/v$1/checksums.txt"
}
